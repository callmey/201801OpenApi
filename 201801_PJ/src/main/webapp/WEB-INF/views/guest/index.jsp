		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li calss="dropdown"><a href="mybatis/dynamicSQL2"
						class="dropdown-toggle" data-toggle="dropdown" role="button"
						aria-haspopup="true" aria-expanded="false">레시피<span
							class="caret"> </span></a>
						<ul class="dropdown-menu">
							<li><a href="dynamicSQL2">테마</a></li>
							<li><a href="dynamicSQL2?ingredient">재료</a></li>
						</ul></li>
				...
				<sec:authorize access="not authenticated">
					<div><a class="btn btn-default" href="${R}guest/login">로그인</a></div>
				</sec:authorize>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<span class="glyphicon-pencil"></span> &nbsp;&nbsp;최신 레시피 목록
				</h3>
			</div>
				...
				<div class="col-sm-2">
					...
					<div class="list-group">
						<a href="#" class="list-group-item">소개</a> <a href="#"
							class="list-group-item">레시피</a> <a href="#"
							class="list-group-item">커뮤니티</a>
					</div>
				</div>
				<div class="col-sm-2">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: center;">
						자신이 만든 요리를 사람들과 공유해보세요. <br> <img src="images/레시피.jpg"
							id="imagepriview" style="width: 256p; height: 256px;">
					</div>
				</div>
			</div>
		</div>
